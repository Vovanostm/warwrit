...
import { canonicalJson, COMPANY_CATALOGUE, COMPANY_COMMAND_JSON_SCHEMA, COMPANY_RULES } from './index.js';
...
describe('WP-02.1 reconstructed source fingerprint', () => {
  it('pins semantic exports without pretending to possess the original archive', () => {
    const manifest = JSON.parse(readFileSync(new URL('../../../../docs/work-packages/WP-02.1-SOURCES.json', import.meta.url), 'utf8')) as {
